KIDS Distribution saved on Apr 07, 2015@22:48:20
...
"RTN","RGUT",2,0)
 ;;3.0;RG UTILITIES;**1**;Mar 20, 2007;Build 366
"RTN","RGUT",3,0)
 ;;
"RTN","RGUT",4,0)
 ;=================================================================
...
"RTN","RGUT1",2,0)
 ;;3.0;RG UTILITIES;;Mar 20, 2007;Build 366
"RTN","RGUT1",3,0)
 ;;
"RTN","RGUT1",4,0)
 ;=================================================================
...
"RTN","RGUTDATF",2,0)
 ;;3.0;RG UTILITIES;;Feb 20, 2015;Build 366
"RTN","RGUTDATF",3,0)
...
"RTN","RGNETTCP",2,0)
 ;;1.0;NETWORK SERVICES;;29-Mar-2015;Build 57
"RTN","RGNETTCP",3,0)
 ;=================================================================
"RTN","RGNETTCP",4,0)
...
"RTN","RGNETWRR",2,0)
 ;;1.0;RGSERV WEB SERVER;;1-Apr-2015;Build 57
"RTN","RGNETWRR",3,0)
 ;=================================================================
"RTN","RGNETWRR",4,0)
...
0^2^B84332119
"RTN","RGNETWWW",1,0)
RGNETWWW ;RI/CBMI/DKM - HTTP support ;07-Apr-2015 22:43;DKM
"RTN","RGNETWWW",2,0)
 ;;1.0;NETWORK SERVICES;;14-March-2014;Build 57
"RTN","RGNETWWW",3,0)
 ;=================================================================
"RTN","RGNETWWW",4,0)
...
"RTN","RGNETBAC",2,0)
 ;;1.0;NETWORK SERVICES;;01-Apr-2015;Build 58
"RTN","RGNETBAC",3,0)
 ;=================================================================
"RTN","RGNETBAC",4,0)
 ; Connect action
...
"RTN","RGNETBLG",2,0)
 ;;1.0;NETWORK SERVICES;;Jan 3, 2008;Build 58
"RTN","RGNETBLG",3,0)
 ;=================================================================
"RTN","RGNETBLG",4,0)
...
"RTN","RGSEFHIJ",2,0)
 ;;1.0;SERIALIZATION FRAMEWORK;;07-Feb-2015 08:51;Build 309
"RTN","RGSEFHIJ",3,0)
 ;=================================================================
"RTN","RGSEFHIJ",4,0)
...
"RTN","RGSEJSON",2,0)
 ;;1.0;SERIALIZATION FRAMEWORK;;14-March-2014;Build 309
"RTN","RGSEJSON",3,0)
 ;=================================================================
"RTN","RGSEJSON",4,0)
 ; Implements Serializer interface
...
0^3^B14629727
"RTN","RGSER",1,0)
RGSER ;RI/CBMI/DKM - Core Serialization Support ;07-Apr-2015 21:58;DKM
"RTN","RGSER",2,0)
 ;;1.0;SERIALIZATION FRAMEWORK;;14-March-2014;Build 309
"RTN","RGSER",3,0)
 ;=================================================================
...
"RTN","RGCWFPAR",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 380
"RTN","RGCWFPAR",3,0)
...
"RTN","RGCWENC1",2,0)
 ;;1.0;CAREWEB FRAMEWORK;**005004;20-Aug-2007 08:41;Build 376
"RTN","RGCWENC1",3,0)
 ; Visit creation API
"RTN","RGCWENC1",4,0)
GETVISIT(IN,OUT) ;
...
"RTN","RGCWFTIU",2,0)
 ;;1.0;RGCW;;14-March-2014;Build 376
"RTN","RGCWFTIU",3,0)
 ;=================================================================
"RTN","RGCWFTIU",4,0)
