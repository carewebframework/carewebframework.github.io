KIDS Distribution saved on Mar 15, 2015@14:19:55
...
"RTN","RGCWFUTL",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 124
"RTN","RGCWFUTL",3,0)
...
"RTN","RGUT",2,0)
 ;;3.0;RG UTILITIES;**1**;Mar 20, 2007;Build 257
"RTN","RGUT",3,0)
 ;;
"RTN","RGUT",4,0)
 ;=================================================================
...
"RTN","RGUT1",2,0)
 ;;3.0;RG UTILITIES;;Mar 20, 2007;Build 257
"RTN","RGUT1",3,0)
 ;;
"RTN","RGUT1",4,0)
 ;=================================================================
...
"RTN","RGUTDATF",2,0)
 ;;3.0;RG UTILITIES;;Feb 20, 2015;Build 257
"RTN","RGUTDATF",3,0)
...
"RTN","CIANBACT",2,0)
 ;;1.3;CIA NETWORK COMPONENTS;;Sep 18, 2007;Build 298
"RTN","CIANBACT",3,0)
...
"RTN","CIANBLOG",2,0)
 ;;1.3;CIA NETWORK COMPONENTS;;Jan 3, 2008;Build 298
"RTN","CIANBLOG",3,0)
 ;;Copyright 2000-2008, Medsphere Systems Corporation
"RTN","CIANBLOG",4,0)
 ;=================================================================
...
0^1^B57156013
"RTN","RGSEFHIR",1,0)
RGSEFHIR ;RI/CBMI/DKM - XML FHIR Support ;15-Mar-2015 14:08;DKM
"RTN","RGSEFHIR",2,0)
 ;;1.0;SERIALIZATION FRAMEWORK;;07-Feb-2015 08:51;Build 149
"RTN","RGSEFHIR",3,0)
 ;=================================================================
"RTN","RGSEFHIR",4,0)
...
"RTN","RGSEJSON",2,0)
 ;;1.0;SERIALIZATION FRAMEWORK;;14-March-2014;Build 149
"RTN","RGSEJSON",3,0)
 ;=================================================================
"RTN","RGSEJSON",4,0)
 ; Implements Serializer interface
...
0^3^B69705076
"RTN","RGSER",1,0)
RGSER ;RI/CBMI/DKM - Core Serialization Support ;15-Mar-2015 13:55;DKM
"RTN","RGSER",2,0)
 ;;1.0;SERIALIZATION FRAMEWORK;;14-March-2014;Build 149
"RTN","RGSER",3,0)
 ;=================================================================
...
0^11^B133238487
"RTN","RGSERGET",1,0)
RGSERGET ;RI/CBMI/DKM - GET method support ;15-Mar-2015 14:18;DKM
"RTN","RGSERGET",2,0)
 ;;1.0;SERIALIZATION FRAMEWORK;;14-March-2014;Build 149
"RTN","RGSERGET",3,0)
 ;=================================================================
...
GETSER(PATH,DATA) ;
"RTN","RGSERGET",140,0)
 N SER,SERNM,START,LEN,LP,MATCH,MTYPE,PTRN,WT,MWT,ACCPT,REJECT,D1,D2,N0
"RTN","RGSERGET",141,0)
 S SERNM=$P(PATH,"/"),START=$P(PATH,"/",2),PATH=$P(PATH,"/",2,999)
"RTN","RGSERGET",142,0)
 S LEN=$L(START),ACCPT=$G(DATA("HDR","accept")),(MATCH,REJECT)=0,SER=+$G(DATA("SER")),MWT=0
"RTN","RGSERGET",143,0)
...
"RTN","RGSERGET",146,0)
 I MATCH D  Q N0
"RTN","RGSERGET",147,0)
 .S:'SER N0=^RGSER(998.1,D1,0),DATA("CTYPE")=$P($P(N0,U,2),","),DATA("INTF")=$P(N0,U,3),DATA("VER")=$P(N0,U,4),DATA("SER")=D1,DATA("SERNM")=SERNM
"RTN","RGSERGET",148,0)
...
"RTN","RGSERGET",150,0)
 Q ""
"RTN","RGSERGET",151,0)
GS1 S LP=START,MATCH=0,MTYPE=$P(^RGSER(998.1,D1,0),U,2),WT=$$ISTYPE^RGSER(MTYPE,ACCPT)
"RTN","RGSERGET",152,0)
 S:'WT REJECT=1
"RTN","RGSERGET",153,0)
 Q:'WT!(WT'>MWT)
...
"RTN","RGCWENC1",2,0)
 ;;1.0;CAREWEB FRAMEWORK;**005004;20-Aug-2007 08:41;Build 272
"RTN","RGCWENC1",3,0)
 ; Visit creation API
"RTN","RGCWENC1",4,0)
GETVISIT(IN,OUT) ;
...
"RTN","RGCWENCX",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 272
"RTN","RGCWENCX",3,0)
...
"RTN","RGCWFTIU",2,0)
 ;;1.0;RGCW;;14-March-2014;Build 272
"RTN","RGCWFTIU",3,0)
 ;=================================================================
"RTN","RGCWFTIU",4,0)
...
RGCKDIN ;RI/CBMI/DKM - CareWeb KIDS installation support ;07-Mar-2015 10:08;DKM
"RTN","RGCWKDIN",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 114
"RTN","RGCWKDIN",3,0)
 ; Environment check
"RTN","RGCWKDIN",4,0)
EC X $G(@XPDGREF@("EC"))
