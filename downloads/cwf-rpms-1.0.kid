KIDS Distribution saved on Mar 06, 2015@13:30:09
...
CAREWEB DISTRIBUTION (RPMS) 1.0
"BLD",8495,0)
CAREWEB DISTRIBUTION (RPMS) 1.0^^1^3150306^n
"BLD",8495,6.3)
84
"BLD",8495,10,0)
^9.63^35^6
...
"RTN","RGCWFUTL",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 84
"RTN","RGCWFUTL",3,0)
...
RG UTILITIES 3.0
"BLD",8503,0)
RG UTILITIES 3.0^RUN TIME LIBRARY^0^3150306^n
"BLD",8503,1,0)
^^3^3^3150202^^^
"BLD",8503,1,1,0)
...
"RTN","RGUT",2,0)
 ;;3.0;RG UTILITIES;**1**;Mar 20, 2007;Build 172
"RTN","RGUT",3,0)
 ;;
"RTN","RGUT",4,0)
 ;=================================================================
...
"RTN","RGUT1",2,0)
 ;;3.0;RG UTILITIES;;Mar 20, 2007;Build 172
"RTN","RGUT1",3,0)
 ;;
"RTN","RGUT1",4,0)
 ;=================================================================
...
"RTN","RGUTDATF",2,0)
 ;;3.0;RG UTILITIES;;Feb 20, 2015;Build 172
"RTN","RGUTDATF",3,0)
...
CIA RPC BROKER 1.3
"BLD",8484,0)
CIA RPC BROKER 1.3^^0^3150306^n
"BLD",8484,1,0)
^9.61A^1^1^3101115^^^^
"BLD",8484,1,1,0)
...
"RTN","CIANBACT",2,0)
 ;;1.3;CIA NETWORK COMPONENTS;;Sep 18, 2007;Build 218
"RTN","CIANBACT",3,0)
...
"RTN","CIANBLOG",2,0)
 ;;1.3;CIA NETWORK COMPONENTS;;Jan 3, 2008;Build 218
"RTN","CIANBLOG",3,0)
 ;;Copyright 2000-2008, Medsphere Systems Corporation
"RTN","CIANBLOG",4,0)
 ;=================================================================
...
"BLD",8505,0)
SERIALIZATION FRAMEWORK 1.0^^0^3150306^n
"BLD",8505,1,0)
^^2^2^3150301.07231
"BLD",8505,1,1,0)
...
"RTN","RGSEFHIR",2,0)
 ;;1.0;SERIALIZATION FRAMEWORK;;07-Feb-2015 08:51;Build 42
"RTN","RGSEFHIR",3,0)
 ;=================================================================
"RTN","RGSEFHIR",4,0)
...
"RTN","RGSEJSON",2,0)
 ;;1.0;SERIALIZATION FRAMEWORK;;14-March-2014;Build 42
"RTN","RGSEJSON",3,0)
 ;=================================================================
"RTN","RGSEJSON",4,0)
 ; Implements Serializer interface
...
"BLD",8485,0)
CAREWEB FRAMEWORK 1.0^CAREWEB FRAMEWORK^0^3150306^n
"BLD",8485,4,0)
^9.64PA^998.1^2
"BLD",8485,4,998.1,0)
998.1
...
CAREWEB CONTEXT 1.0
"BLD",8487,0)
CAREWEB CONTEXT 1.0^^0^3150306^n
"BLD",8487,4,0)
^9.64PA^998.1^4
"BLD",8487,4,998.1,0)
998.1
...
"RTN","RGCWENC1",2,0)
 ;;1.0;CAREWEB FRAMEWORK;**005004;20-Aug-2007 08:41;Build 192
"RTN","RGCWENC1",3,0)
 ; Visit creation API
"RTN","RGCWENC1",4,0)
GETVISIT(IN,OUT) ;
...
"RTN","RGCWENCX",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 192
"RTN","RGCWENCX",3,0)
...
"RTN","RGCWFTIU",2,0)
 ;;1.0;RGCW;;14-March-2014;Build 192
"RTN","RGCWFTIU",3,0)
 ;=================================================================
"RTN","RGCWFTIU",4,0)
...
"BLD",8497,0)
CAREWEB RPMS ENHANCEMENTS 1.0^^0^3150306^n
"BLD",8497,4,0)
^9.64PA^998.1^3
"BLD",8497,4,998.1,0)
998.1
