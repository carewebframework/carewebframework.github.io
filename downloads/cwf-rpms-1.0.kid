KIDS Distribution saved on Mar 15, 2015@12:17:07
...
CAREWEB DISTRIBUTION (RPMS) 1.0
"BLD",8495,0)
CAREWEB DISTRIBUTION (RPMS) 1.0^^1^3150315^n
"BLD",8495,6.3)
123
"BLD",8495,10,0)
^9.63^35^6
...
"RTN","RGCWFUTL",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 123
"RTN","RGCWFUTL",3,0)
...
RG UTILITIES 3.0
"BLD",8503,0)
RG UTILITIES 3.0^RUN TIME LIBRARY^0^3150315^n
"BLD",8503,1,0)
^^3^3^3150202^^^
"BLD",8503,1,1,0)
...
"RTN","RGUT",2,0)
 ;;3.0;RG UTILITIES;**1**;Mar 20, 2007;Build 255
"RTN","RGUT",3,0)
 ;;
"RTN","RGUT",4,0)
 ;=================================================================
...
"RTN","RGUT1",2,0)
 ;;3.0;RG UTILITIES;;Mar 20, 2007;Build 255
"RTN","RGUT1",3,0)
 ;;
"RTN","RGUT1",4,0)
 ;=================================================================
...
"RTN","RGUTDATF",2,0)
 ;;3.0;RG UTILITIES;;Feb 20, 2015;Build 255
"RTN","RGUTDATF",3,0)
...
CIA RPC BROKER 1.3
"BLD",8484,0)
CIA RPC BROKER 1.3^^0^3150315^n
"BLD",8484,1,0)
^9.61A^1^1^3101115^^^^
"BLD",8484,1,1,0)
...
"RTN","CIANBACT",2,0)
 ;;1.3;CIA NETWORK COMPONENTS;;Sep 18, 2007;Build 296
"RTN","CIANBACT",3,0)
...
"RTN","CIANBLOG",2,0)
 ;;1.3;CIA NETWORK COMPONENTS;;Jan 3, 2008;Build 296
"RTN","CIANBLOG",3,0)
 ;;Copyright 2000-2008, Medsphere Systems Corporation
"RTN","CIANBLOG",4,0)
 ;=================================================================
...
"BLD",8505,0)
SERIALIZATION FRAMEWORK 1.0^SERIALIZATION FRAMEWORK^0^3150315^n
"BLD",8505,1,0)
^^2^2^3150301.07231
"BLD",8505,1,1,0)
...
_id^@ien^T^10
"DATA",998.1,2,0)
DSTU1^text/xml^RGSEFHIR^0.0.82-3059
"DATA",998.1,2,10,0)
^998.11^46^46
"DATA",998.1,2,10,1,0)
Binary
...
0^1^B57229318
"RTN","RGSEFHIR",1,0)
RGSEFHIR ;RI/CBMI/DKM - XML FHIR Support ;15-Mar-2015 10:12;DKM
"RTN","RGSEFHIR",2,0)
 ;;1.0;SERIALIZATION FRAMEWORK;;07-Feb-2015 08:51;Build 146
"RTN","RGSEFHIR",3,0)
 ;=================================================================
"RTN","RGSEFHIR",4,0)
...
"RTN","RGSEJSON",2,0)
 ;;1.0;SERIALIZATION FRAMEWORK;;14-March-2014;Build 146
"RTN","RGSEJSON",3,0)
 ;=================================================================
"RTN","RGSEJSON",4,0)
 ; Implements Serializer interface
...
0^3^B61820477
"RTN","RGSER",1,0)
RGSER ;RI/CBMI/DKM - Core Serialization Support ;13-Mar-2015 13:18;DKM
"RTN","RGSER",2,0)
 ;;1.0;SERIALIZATION FRAMEWORK;;14-March-2014;Build 146
"RTN","RGSER",3,0)
 ;=================================================================
...
0^11^B132337989
"RTN","RGSERGET",1,0)
RGSERGET ;RI/CBMI/DKM - GET method support ;15-Mar-2015 09:36;DKM
"RTN","RGSERGET",2,0)
 ;;1.0;SERIALIZATION FRAMEWORK;;14-March-2014;Build 146
"RTN","RGSERGET",3,0)
 ;=================================================================
...
"RTN","RGSERGET",146,0)
 I MATCH D  Q N0
"RTN","RGSERGET",147,0)
 .S:'SER N0=^RGSER(998.1,D1,0),DATA("CTYPE")=$P(N0,U,2),DATA("INTF")=$P(N0,U,3),DATA("VER")=$P(N0,U,4),DATA("SER")=D1,DATA("SERNM")=SERNM
"RTN","RGSERGET",148,0)
...
This is the default MIME type of the returned content.  It is used to match the
"^DD",998.1,998.1,1,21,2,0)
requestor's desired content type.  This allows having multiple entries with the
"^DD",998.1,998.1,1,21,3,0)
same name, but different content types.  By default, the value of this entry is
...
"BLD",8485,0)
CAREWEB FRAMEWORK 1.0^CAREWEB FRAMEWORK^0^3150315^n
"BLD",8485,4,0)
^9.64PA^998.1^2
"BLD",8485,4,998.1,0)
998.1
...
"RTN","RGCWFPAR",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 274
"RTN","RGCWFPAR",3,0)
...
CAREWEB CONTEXT 1.0
"BLD",8487,0)
CAREWEB CONTEXT 1.0^^0^3150315^n
"BLD",8487,4,0)
^9.64PA^998.1^4
"BLD",8487,4,998.1,0)
998.1
...
"RTN","RGCWENC1",2,0)
 ;;1.0;CAREWEB FRAMEWORK;**005004;20-Aug-2007 08:41;Build 270
"RTN","RGCWENC1",3,0)
 ; Visit creation API
"RTN","RGCWENC1",4,0)
GETVISIT(IN,OUT) ;
...
"RTN","RGCWFTIU",2,0)
 ;;1.0;RGCW;;14-March-2014;Build 270
"RTN","RGCWFTIU",3,0)
 ;=================================================================
"RTN","RGCWFTIU",4,0)
...
"BLD",8497,0)
CAREWEB RPMS ENHANCEMENTS 1.0^^0^3150315^n
"BLD",8497,4,0)
^9.64PA^998.1^3
"BLD",8497,4,998.1,0)
998.1
...
RGCKDIN ;RI/CBMI/DKM - CareWeb KIDS installation support ;07-Mar-2015 10:08;DKM
"RTN","RGCWKDIN",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 113
"RTN","RGCWKDIN",3,0)
 ; Environment check
"RTN","RGCWKDIN",4,0)
EC X $G(@XPDGREF@("EC"))
