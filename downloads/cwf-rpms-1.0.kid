KIDS Distribution saved on Apr 14, 2015@12:04:05
...
CAREWEB DISTRIBUTION (RPMS) 1.0
"BLD",8495,0)
CAREWEB DISTRIBUTION (RPMS) 1.0^^1^3150414^n
"BLD",8495,6.3)
184
"BLD",8495,10,0)
^9.63^600^9
...
"RTN","RGCWFUTL",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 184
"RTN","RGCWFUTL",3,0)
...
RG UTILITIES 3.0
"BLD",8503,0)
RG UTILITIES 3.0^RG UTILITIES^0^3150414^n
"BLD",8503,1,0)
^^3^3^3150202^^^
"BLD",8503,1,1,0)
...
"RTN","RGUT",2,0)
 ;;3.0;RG UTILITIES;**1**;Mar 20, 2007;Build 382
"RTN","RGUT",3,0)
 ;;
"RTN","RGUT",4,0)
 ;=================================================================
...
"RTN","RGUT1",2,0)
 ;;3.0;RG UTILITIES;;Mar 20, 2007;Build 382
"RTN","RGUT1",3,0)
 ;;
"RTN","RGUT1",4,0)
 ;=================================================================
...
"RTN","RGUTDATF",2,0)
 ;;3.0;RG UTILITIES;;Feb 20, 2015;Build 382
"RTN","RGUTDATF",3,0)
...
"RTN","RGNETTCP",2,0)
 ;;1.0;NETWORK SERVICES;;29-Mar-2015;Build 81
"RTN","RGNETTCP",3,0)
 ;=================================================================
"RTN","RGNETTCP",4,0)
...
"RTN","RGNETWRR",2,0)
 ;;1.0;RGSERV WEB SERVER;;1-Apr-2015;Build 81
"RTN","RGNETWRR",3,0)
 ;=================================================================
"RTN","RGNETWRR",4,0)
...
"RTN","RGNETWWW",2,0)
 ;;1.0;NETWORK SERVICES;;14-March-2014;Build 81
"RTN","RGNETWWW",3,0)
 ;=================================================================
"RTN","RGNETWWW",4,0)
...
"RTN","RGNETBAC",2,0)
 ;;1.0;NETWORK SERVICES;;01-Apr-2015;Build 82
"RTN","RGNETBAC",3,0)
 ;=================================================================
"RTN","RGNETBAC",4,0)
 ; Connect action
...
"RTN","RGNETBLG",2,0)
 ;;1.0;NETWORK SERVICES;;Jan 3, 2008;Build 82
"RTN","RGNETBLG",3,0)
 ;=================================================================
"RTN","RGNETBLG",4,0)
...
"BLD",8505,0)
SERIALIZATION FRAMEWORK 1.0^SERIALIZATION FRAMEWORK^0^3150414^n
"BLD",8505,1,0)
^^2^2^3150301.07231
"BLD",8505,1,1,0)
...
"RTN","RGSEFHIJ",2,0)
 ;;1.0;SERIALIZATION FRAMEWORK;;07-Feb-2015 08:51;Build 333
"RTN","RGSEFHIJ",3,0)
 ;=================================================================
"RTN","RGSEFHIJ",4,0)
...
"RTN","RGSEJSON",2,0)
 ;;1.0;SERIALIZATION FRAMEWORK;;14-March-2014;Build 333
"RTN","RGSEJSON",3,0)
 ;=================================================================
"RTN","RGSEJSON",4,0)
 ; Implements Serializer interface
...
"BLD",8485,0)
CAREWEB FRAMEWORK 1.0^CAREWEB FRAMEWORK^0^3150414^n
"BLD",8485,4,0)
^9.64PA^996.54^2
"BLD",8485,4,996.54,0)
996.54
...
"RTN","RGCWFPAR",2,0)
 ;;1.0;CAREWEB FRAMEWORK;;;Build 396
"RTN","RGCWFPAR",3,0)
...
CAREWEB CONTEXT 1.0
"BLD",8487,0)
CAREWEB CONTEXT 1.0^^0^3150414^n
"BLD",8487,4,0)
^9.64PA^998.1^4
"BLD",8487,4,998.1,0)
998.1
...
"RTN","RGCWENC1",2,0)
 ;;1.0;CAREWEB FRAMEWORK;**005004;20-Aug-2007 08:41;Build 392
"RTN","RGCWENC1",3,0)
 ; Visit creation API
"RTN","RGCWENC1",4,0)
GETVISIT(IN,OUT) ;
...
"RTN","RGCWFTIU",2,0)
 ;;1.0;RGCW;;14-March-2014;Build 392
"RTN","RGCWFTIU",3,0)
 ;=================================================================
"RTN","RGCWFTIU",4,0)
...
"BLD",8497,0)
CAREWEB RPMS ENHANCEMENTS 1.0^^0^3150414^n
"BLD",8497,4,0)
^9.64PA^998.1^3
"BLD",8497,4,998.1,0)
998.1
